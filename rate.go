...
// Size returns the number of bytes transferrable given the input rate and
// duration.
...
// NBits returns the quantity of bits/second that the Rate represents. If
// the input Rate is not in the non-inclusive range (-1 EiB/s, 1 EiB/s),
// rather than wrap around on overflow, the result will be truncated to the
